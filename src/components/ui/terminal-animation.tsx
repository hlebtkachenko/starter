...
const TerminalAnimationContext = React.createContext<TerminalAnimationContextValue | undefined>(
  undefined,
);
...
export const defaultTerminalTabs: TabContent[] = [
  {
    ...
    lines: [
      ...
      { text: "    Vanilla", color: "text-muted-foreground", delay: 80 },
      { text: "    Vue", color: "text-muted-foreground", delay: 80 },
      { text: "  > React", color: "text-primary", delay: 80 },
      { text: "    Preact", color: "text-muted-foreground", delay: 80 },
      { text: "    Svelte", color: "text-muted-foreground", delay: 80 },
      { text: "", delay: 200 },
      {
      ...
      { text: "  > TypeScript", color: "text-primary", delay: 80 },
      { text: "", delay: 200 },
      { text: "  Done. Now run:", color: "text-muted-foreground", delay: 300 },
      { text: "", delay: 50 },
      { text: "    cd my-app", color: "text-foreground", delay: 100 },
      { text: "    vite dev", color: "text-foreground", delay: 100 },
    ],
  },
  {
    label: "dev",
  ...
  },
  {
    ...
    lines: [
      ...
      { text: "", delay: 80 },
      { text: "  Fixed  src/App.tsx", color: "text-primary", delay: 150 },
      {
      ...
      { text: "", delay: 80 },
      { text: "  3 files formatted", color: "text-foreground", delay: 200 },
      {
        text: "  39 files unchanged",
        color: "text-muted-foreground",
        delay: 100,
      },
      { text: "", delay: 80 },
      { text: "  Done in 4ms", color: "text-muted-foreground", delay: 200 },
    ],
  },
  {
    label: "test",
    ...
    lines: [
      { text: "", delay: 80 },
      { text: "  RUN  v6.3.0", color: "text-primary", delay: 300 },
      { text: "", delay: 80 },
      {
        text: "  src/utils.test.ts",
        color: "text-muted-foreground",
        delay: 200,
      },
      {
      ...
      { text: "", delay: 80 },
      { text: "  Tests  5 passed (5)", color: "text-primary", delay: 200 },
      { text: "  Time   38ms", color: "text-muted-foreground", delay: 100 },
    ],
  },
  {
    label: "build",
    ...
    lines: [
      ...
      { text: "", delay: 80 },
      { text: "  transforming...", color: "text-muted-foreground", delay: 300 },
      {
      ...
      { text: "", delay: 80 },
      { text: "  ✓ built in 218ms", color: "text-primary", delay: 300 },
    ],
  },
];
...
export function TerminalAnimationRoot({
  ...
  const animateTab = React.useCallback(
    (tabIndex: number) => {
      clearTimeouts();
      setVisibleLines(0);
      setCommandTyped("");
...
const backgroundGradientClasses =
  "absolute inset-0 bg-gradient-to-br from-primary/40 via-primary/30 to-background";
