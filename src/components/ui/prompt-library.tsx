...
const PromptLibraryContext = React.createContext<PromptLibraryContextValue | null>(null);
...
export function PromptLibrary({
  ...
  const [internalPrompts, setInternalPrompts] = React.useState<Prompt[]>(controlledPrompts ?? []);
  ...
  const contextValue = React.useMemo<PromptLibraryContextValue>(
    () => ({
      prompts,
      addCustom,
      removeCustom,
...
export type PromptLibraryContentProps = React.ComponentProps<typeof PopoverContent>;
...
export type PromptLibraryGroupProps = React.ComponentProps<typeof CommandGroup>;
...
export type PromptLibrarySeparatorProps = React.ComponentProps<typeof CommandSeparator>;
