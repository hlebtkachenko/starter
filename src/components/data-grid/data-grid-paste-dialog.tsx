...
interface PasteDialogProps extends Required<Pick<TableMeta<unknown>, "pasteDialog">> {
  onPasteDialogOpenChange?: TableMeta<unknown>["onPasteDialogOpenChange"] | undefined;
  onCellsPaste?: TableMeta<unknown>["onCellsPaste"] | undefined;
}
